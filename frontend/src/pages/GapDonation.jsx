...
// Donation
// Donation tax documentation generator

export default function GapDonation() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-donation', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Donation</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Donation tax documentation generator</p>
