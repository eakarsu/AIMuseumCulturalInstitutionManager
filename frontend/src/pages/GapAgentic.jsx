...
// Agentic
// Agentic collection curator suggesting exhibition concepts and educational narratives
...
export default function GapAgentic() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Agentic collection curator suggesting exhibition concepts and educational narratives</p>
