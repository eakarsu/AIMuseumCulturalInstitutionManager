...
export default function GapTeacher() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-teacher', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Teacher</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Teacher resources & lesson planning</p>
