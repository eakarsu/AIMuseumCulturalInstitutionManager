...
// Vision Based
// Vision-based artifact documentation (photo + measurement + condition extraction)

export default function GapVisionBased() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-vision-based', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Vision Based</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Vision-based artifact documentation (photo + measurement + condition extraction)</p>
      ...
      <div style={{ background: '#fff', border: '1px solid #e5e7eb', borderRadius: 8, padding: 20, marginBottom: 20 }}>
        ...
        <div style={{ marginTop: 12, display: 'flex', gap: 8 }}>
          ...
          >
            {loading ? 'Running...' : 'Run Vision Based'}
          </button>
          <button
