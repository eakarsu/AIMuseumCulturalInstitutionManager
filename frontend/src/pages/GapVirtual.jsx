...
// Virtual
// Virtual tour / 3D collection viewing

export default function GapVirtual() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-virtual', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Virtual</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Virtual tour / 3D collection viewing</p>
