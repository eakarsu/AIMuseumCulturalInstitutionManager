...
// Autonomous
// Autonomous conservation assistant predicting deterioration
...
export default function GapAutonomous() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Autonomous conservation assistant predicting deterioration</p>
