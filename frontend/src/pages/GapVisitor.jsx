...
// Visitor
// Visitor portal (ticketing, membership, content)

export default function GapVisitor() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-visitor', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Visitor</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Visitor portal (ticketing, membership, content)</p>
