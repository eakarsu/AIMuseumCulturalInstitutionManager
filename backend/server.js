...
// Generated CRUD, direct AI/autonomous, visitor-agent, and gap routes are intentionally unmounted.
app.use('/api',(_req,res)=>res.status(404).json({error:'Not found'}));
const port=Number(process.env.BACKEND_PORT||4000);app.listen(port,()=>console.log(`Governed museum API listening on ${port}`));
export default app;
